...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__domain_index_js__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_meucss_css__ = __webpack_require__(37);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./meucss.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./meucss.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
